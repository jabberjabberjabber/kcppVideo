...
def process_video(video_path: str | Path) -> list[str]:
    """
    ...
    n_frames = smart_nframes(total_frames, video_fps)
...
def analyze_video(video_path: str, api_url: str, template_dir: str,
    ...
    frames, total_length = process_video(video_path)
